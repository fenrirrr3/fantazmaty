...
# Jawnie wskazany plik projektu; zmienne procesu mają pierwszeństwo.
# Bez interpolacji, aby znaki ${...} w hasłach pozostały dosłowne.
load_dotenv(BASE_DIR / ".env", override=False, interpolate=False, encoding="utf-8")
...
# Ustawienia pochodzą z pliku .env lub środowiska procesu.
